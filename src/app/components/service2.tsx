      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2 font-medium transition-all duration-300
                  ${
                    isActive
                      ? "bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full shadow-lg shadow-purple-300/50"
        ...
        <div className="grid md:grid-cols-12 gap-10 items-center">
          ...
          <div className="md:col-span-5">
            <div className="relative w-full h-[320px] rounded-xl overflow-hidden shadow">
              <Image
                src="/about04.jpg"
            ...
            <ul className="space-y-4">
              {tabs[activeTab].points.map((point, idx) => (
                <li key={idx} className="flex gap-3">
                  <HiCheckCircle className="text-indigo-600 mt-1 text-lg flex-shrink-0" />
