          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 col-md-12 mb-3">
                <h2 className="title mb-0 text-center md:text-5xl font-semibold">
            ...
            <div className="row mt-10 mt-md-5">
              <div className="col-lg-12 col-md-12">
                ...
                <h4 className="text-theme text-blue-600 md:text-2xl  font-semibold md:mb-5 md:ml-15">1. Description of Service</h4>
                <p className="mb-3 md:text-xl md:ml-15 font-Poppins text-justify">
                ...
                <h4 className="text-theme text-blue-600 md:text-2xl font-semibold md:mb-5 md:ml-15">2. Information</h4>
                <p className="mb-3 md:text-xl md:ml-15 font-Poppins text-justify">
                ...
                <h4 className="text-theme text-blue-600 md:text-2xl font-semibold md:mb-5 md:ml-15">3. Fees and Payment</h4>
                <p className="mb-3 md:text-xl md:ml-15 font-Poppins text-justify">
                ...
                <h4 className="text-theme text-blue-600 md:text-2xl font-semibold md:mb-5 md:ml-15   ">4. Performance</h4>
                <p className="mb-3 md:text-xl md:ml-15 font-Poppins text-justify">
                ...
                <h4 className="text-theme text-blue-600 md:text-2xl font-semibold md:mb-5 md:ml-15">5. Terms</h4>
                <p className="mb-4 mb-md-5  md:text-xl md:ml-15 font-Poppins text-justify">
                ...
                <h4 className="text-theme text-blue-600 md:text-2xl font-semibold md:mb-5 md:ml-15">6. Termination</h4>
                <p className="mb-4 mb-md-5  md:text-xl md:ml-15 font-Poppins text-justify">
                ...
                {/* Responsive Buttons */}
                <div className="flex flex-column flex-sm-row md:h-10  md:gap-10 md:p-5 md:m-10 gap-3">
                  <Link href="/" >
                    <button className="btn h-15 w-25 text-xl bg-blue-600 font-semibold font-Poppins text-white hover:bg-red-400 rounded-sm p-4  hover:cursor-grab ">Accept</button>
                  </Link>
                  <Link href="/" className="btn btn-border mb-7">
                     <button className="btn h-15 w-25 text-xl bg-white font-semibold font-Poppins text-black border-2 border-black hover:bg-blue-600 rounded-sm p-4   hover:cursor-grab ">Close</button>
                  </Link>
                </div>
