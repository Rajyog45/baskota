  ...
  export default function Navbar(): JSX.Element {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <nav className="hidden  xl:flex gap-4 xl:gap-10 text-white font-bold  xl:text-lg 2xl:text-xl mt-6 ">
            ...
            <AnimatePresence>
              {menuOpen && (
                <motion.div
                  ...
                  exit={{ height: 0, opacity: 0 }}
                >
                  <Link href="/" className="bg-blue-700 pl-1">Home</Link>
                  <Link href="/about">About</Link>
                  <Link href="/services">Services</Link>
                  <Link href="/faq">FAQs</Link>
                  <Link href="/team">Team</Link>
        ...
        {/* HERO CONTENT */}
        <section className="relative flex items-center justify-center text-center z-10 min-h-screen pt-[120px] px-4">
          <motion.div
            key={current}
